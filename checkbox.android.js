...
var CheckBox = (function (_super) {
    ...
    Object.defineProperty(CheckBox.prototype, "scale", {
        get: function () {
            return this._scale;
        },
        set: function (scale) {
    ...
    CheckBox.prototype.updateFillColor = function (color) {
        if (this._android) {
            var colorDef = new color_1.Color(color).android;
            if (platform_1.device.sdkVersion == "21") {
                this._android.setButtonTintList(android.content.res.ColorStateList.valueOf(colorDef));
            }
            else if (platform_1.device.sdkVersion > "21") {
                var stateArray = Array.create("[I", 2);
                stateArray[0] = Array.create("int", 1);
                stateArray[1] = Array.create("int", 1);
                stateArray[0][0] = -android.R.attr.state_checked;
                stateArray[1][0] = android.R.attr.state_checked;
                var colorArray = Array.create("int", 2);
                colorArray[0] = android.graphics.Color.GRAY;
                colorArray[1] = colorDef;
                var colorStateList = new android.content.res.ColorStateList(stateArray, colorArray);
                this._android.setButtonTintList(colorStateList);
            }
            else {
                android.support.v4.widget.CompoundButtonCompat.setButtonTintList(this._android, android.content.res.ColorStateList.valueOf(colorDef));
            }
        }
    };
